...
const TIER_INFO = {
  ...
  skelz_premium: {
    ...
    models: ['qwen-max', 'qwen2.5-7b-instruct', 'qwen2.5-72b-instruct', 'qwen2.5-coder-32b-instruct', 'qwq-plus', 'qwen3-max', 'qwen3-235b-a22b', 'qwen3-coder-plus', 'qwen3-next-80b-a3b-instruct', 'qwen3.5-plus', 'qwen3.6-plus', 'qwen3.7-plus', 'qwen-vl-max', 'qwen-vl-plus', 'qwen3-vl-plus', 'qwen3-vl-flash']
  },
  all: {
